...
fetchBreeds()
  ...
  .catch(() => Notiflix.Notify.failure('Oops! Something went wrong while fetching breeds.'));
...
function catInfo() {
  ...
  fetchCatByBreed(selectedValue)
    ...
    .catch(() => Notiflix.Notify.failure('Oops! Something went wrong while fetching cat information.'));
}
